          ...
          {isMobile && (
            <>
              <motion.div
                ...
                className="absolute bottom-0 left-0 right-0 bg-white rounded-t-3xl p-6 max-h-[70vh] overflow-y-auto z-20"
                onClick={(e) => e.stopPropagation()}
              >
              ...
              <button
                onClick={onClose}
                className="absolute top-8 right-8 z-30 p-3 bg-white rounded-full shadow-lg opacity-80 hover:opacity-100 transition-opacity"
              >
                <X className="w-7 h-7" />
              </button>
            </>
